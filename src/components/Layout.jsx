  ...
  return (
    <footer className="v46-approved-footer">
      ...
      <div className="footer-bottom shell">
        <span>
          © 2026 V Pilot Cyber Solutions LLP.
          All rights reserved.
        </span>
  ...
  return (
    <section className="cta shell">
      <div>
        ...
        <h2>
          Define the right security operating
          model for your business.
        </h2>

        <p>
          Map priority services, threat
          context, authoritative data,
          decision roles, recovery objectives
